...
for i = 1:23                       
    ...
    for j = 1:30
        ...
        [Best_score_GA,Best_pos_GA,GA_curve]=GA(SearchAgents,Max_iterations,lowerbound,upperbound,dimension,fitness);
        ...
        if Best_score_GA < best_fitness(i,3)
           best_fitness(i,3) = Best_score_GA;
           best_convergence(i,3,:) = GA_curve;
        end
    end
    subplot(5,5,i)
    hold on;
