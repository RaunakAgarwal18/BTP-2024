...
%    Appreciated results can be obtained with a small number of iterations.   
 ...
 clear 
 iji = 18;
 if iji==0;F=('PPP');elseif iji==1;F=('F1');elseif iji==2;F=('F2');elseif iji==3;F=('F3');elseif iji==4;F=('F4');elseif iji==5;F=('F5'); ...
...
figure,plot(arr,Convergence_curve); title( F ); xlabel('Iteration'); ylabel('Best score');
